    ...
    <div className="content"> 
        ...
        <div className="admin-dashboard-text-div pt-5"> 
          ...
          <DataGrid
            ...
            initialState={{
              pagination: {
                paginationModel: { page: localStorage.getItem('insurancePackageHeaderPage') ? parseInt(localStorage.getItem('insurancePackageHeaderPage')) : 0, pageSize: 5 },
              },
            }}
            components={{
              Toolbar: () => (
            ...
            onStateChange={(state) => {
              ...
              localStorage.setItem('insurancePackageHeaderPage', currentPage);
